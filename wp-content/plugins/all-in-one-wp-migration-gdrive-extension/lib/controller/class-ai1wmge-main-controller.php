...
class Ai1wmge_Main_Controller {
	...
	public function ai1wm_loaded() {
		if ( ! defined( 'AI1WM_PLUGIN_NAME' ) ) {
			...
			if ( defined( 'AI1WMGE_STATS_URL' ) ) {
				add_action( 'ai1wm_status_export_done', 'Ai1wmge_Stats_Controller::export' );
				add_action( 'ai1wm_status_import_done', 'Ai1wmge_Stats_Controller::import' );
			}
		}
	}
	...
	public function init() {
		if ( isset( $_GET['ai1wmge-token'] ) ) {
			update_option( 'ai1wmge_gdrive_token', urldecode( $_GET['ai1wmge-token'] ) );
